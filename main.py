...
video_patch_args.add_argument("views", type=int, help="Name of the video")
video_patch_args.add_argument("likes", type=int, help="Name of the video")
...
class Video(Resource):
    ...
    def patch(self, video_id):
        ...
        # You dont need to add it to the database
        # The changes you make are all saved when you do commit once the object
